...
class _$StoreGroupImpl implements _StoreGroup {
  ...
  @override
  String toString() {
    return 'StoreGroup(id: $id, name: $name, description: $description, createdByUid: $createdByUid, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, createdByUid, createdAt);
...
abstract class _StoreGroup implements StoreGroup {
  const factory _StoreGroup(
      ...
      required final int createdAt}) = _$StoreGroupImpl;
